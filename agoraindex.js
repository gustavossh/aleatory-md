...
var keyale = "Key-saymon(jsinfinity)2.0"
...
require('./msgs.js')(conn, body, reply)
...
*NÃO MANDE ÁUDIO, DIGITE OK*`, "", [{index: 1, 
urlButton: {displayText: 'CANAL TELEGRAM', url: 'https://t.me/batmonn'}}, 
{index: 2, quickReplyButton: {displayText: 'MENU PRINCIPAL', id: `${prefix}menu2`}}, 
{index: 3, quickReplyButton: {displayText: 'SOBRE A INTERNET', id: `${prefix}hospedar`}},    
{index: 4, quickReplyButton: {displayText: 'SOBRE A IPTV', id: `${prefix}iptv`}},  
{index: 5, quickReplyButton: {displayText: '⚓ TESTE SSH GRATIS ⚓', id:`${prefix}sshgratis`}}], selo)
...
{index: 3, quickReplyButton: {displayText: 'SOBRE A INTERNET', id: `${prefix}hospedar`}},
{index: 4, quickReplyButton: {displayText: 'SOBRE A  IPTV', id: `${prefix}iptv`}},
{index: 5, quickReplyButton: {displayText: 'TESTE DE INTERNET', id: `${prefix}sshgratis`}}], selo)
...
{index: 2, quickReplyButton: {displayText: 'MENU ADMNISTRADORES', id: `${prefix}menuadm`}}, 
...
Com todos os canais disponíveis em território brasileiro, português, americano, africano e asiático Cerca de 8000 filmes, 2260 series completas. 
...
sendBimg(from,texto, "Menu iptv", [{buttonId: `A`, buttonText: {displayText: `Sim`}, type: 1}, {buttonId: `B`, buttonText: {displayText: `Não`}, type: 1}], selo) 
break
